...
>
  ...
  >
    Kreatívna agentúra pôsobiaca na trhu od roku 2012.
    Prémiové polepy, branding a vizuálna komunikácia.
  </p>
</motion.div>
        </div>
      </section>
...
>
  ...
  <h2 className="text-2xl sm:text-3xl font-space font-bold text-white mb-6">
    Od roku 2012 formujeme vizuálny svet
  </h2>
  ...
  >
    KKFOL je reklamná agentúra so sídlom v Kežmarku,
    ktorá sa špecializuje na prémiové polepy vozidiel,
    branding a vizuálnu komunikáciu.
  </p>
  ...
  <p
    ...
    style={{ color: 'rgba(255,255,255,0.55)' }}
  >
    Začínali sme ako malé lokálne štúdio zamerané na
    polepy vozidiel. Postupne sme rozšírili portfólio
    o branding, veľkoplošnú tlač, reklamné pútače
    a kompletný grafický dizajn.
  </p>
  ...
  <p
    ...
    style={{ color: 'rgba(255,255,255,0.55)' }}
  >
    Naša sila spočíva v kombinácii prémiových materiálov,
    certifikovaných technikov a osobného prístupu.
  </p>
</motion.div>
...
>
  ...
  <h2 className="text-3xl sm:text-4xl font-space font-bold text-white mb-5">
    Premieňame vozidlá a priestory na nástroje komunikácie
  </h2>
  ...
  >
    Veríme, že kvalitná vizuálna identita nie je luxus,
    ale nevyhnutnosť. Naším cieľom je pomôcť firmám
    a jednotlivcom komunikovať svoju hodnotu cez
    prémiový dizajn.
  </p>
</motion.div>
...
>
  ...
  <div className="text-4xl font-space font-bold text-white mb-1">
    {stat.value}
  </div>
